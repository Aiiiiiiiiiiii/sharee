...
CREATE TABLE `category`  (
  ...
  `category_name` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `category_descn` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`category_id`, `category_name`) USING BTREE
...
CREATE TABLE `post`  (
  ...
  `post_to_uid` int(11) NULL DEFAULT NULL,
  `post_content` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `post_date` datetime NOT NULL,
  `post_from_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `post_to_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `post_id`(`post_id`) USING BTREE,
  INDEX `post_to_uid`(`post_from_uid`) USING BTREE,
...
CREATE TABLE `src`  (
  ...
  `category` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '资源分类',
  `descn` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '资源详情',
  `code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '资源代码',
  `img` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '资源预览图',
  `date` char(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '资源上传时间',
  `uploader` int(255) NULL DEFAULT NULL COMMENT '资源上传者id',
  `up` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'up主',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `user`  (
  ...
  `user_selfdescn` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `user_speak` int(11) NOT NULL,
  `user_number` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `back_pass_tip` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (4, '小黄', '123', '我是大东', 0, '13645645654', '发送');
INSERT INTO `user` VALUES (856, '哆啦坤梦', '123', '我是哆啦坤梦', 0, '13699999999', '发送');
INSERT INTO `user` VALUES (1000, '小红', '123', '我是小红', 1, '11111111111', '发送');
INSERT INTO `user` VALUES (1001, '小明', '123', '我是小明', 0, '22222222222', '发送');
INSERT INTO `user` VALUES (1002, '小花', '123', '我是小花', 0, '33333333333', '发送');
INSERT INTO `user` VALUES (1004, '小云', '123', '我是小云', 1, '55555555555', '发送');
INSERT INTO `user` VALUES (1005, '小亮', '123', '我是小亮', 1, '66666666666', '发送');
INSERT INTO `user` VALUES (1006, '小王', '123', '我是小王', 1, '77777777777', '发送');
INSERT INTO `user` VALUES (1007, '绿谷', '123', '我是绿谷', 1, '88888888888', '发送');
INSERT INTO `user` VALUES (1008, '出久', '123', '我是出久', 0, '96999999999', '发送');
INSERT INTO `user` VALUES (1009, '欧尔麦特', '123', '我是欧尔麦特', 1, '1010', '发送');
INSERT INTO `user` VALUES (1010, '小胜', '123', '我是小胜', 1, '2020', '发送');
INSERT INTO `user` VALUES (1011, '郑大炳', '123', '我是坤坤', 1, '3030', '发送');
INSERT INTO `user` VALUES (1012, '正小兵', '123', '我是小兵', 0, '4040', '发送');
INSERT INTO `user` VALUES (1013, '老王', '123', '我是老王', 1, '5050', '发送');
INSERT INTO `user` VALUES (1234, '阿阿斯顿', '111', '阿斯顿', 1, '10086100861', '发送');
INSERT INTO `user` VALUES (4332, '东', '123', '我是帅哥', 1, '6060', '发送');
INSERT INTO `user` VALUES (4396, '厂长', '123', '我是厂长', 1, '7070', '发送');
INSERT INTO `user` VALUES (4397, 'aaa', 'aaa', 'aaa', 1, '123123', '发送');
INSERT INTO `user` VALUES (4398, '余坤梦', '123', '帅哥', 1, '13288557003', '发送');
INSERT INTO `user` VALUES (4399, '余坤梦', '123', '帅哥', 1, '13288557001', '发送');
INSERT INTO `user` VALUES (4400, '余坤梦', '123', '帅哥', 1, '13288557000', '&#25968;&#23383;');
INSERT INTO `user` VALUES (4401, '余坤梦', '123', '帅哥', 1, '13288557005', '&#25968;&#23383;');
INSERT INTO `user` VALUES (4402, '余坤梦', '123', '帅哥', 1, '13288557006', '&#25968;&#23383;');
INSERT INTO `user` VALUES (4403, '', '123', '帅哥数字', 1, '13645645653', '发送');
INSERT INTO `user` VALUES (4404, '余', '123', '数字', 1, '13288557011', '发送');
INSERT INTO `user` VALUES (4405, '余', '111', '', 1, '13288557111', '数字');
INSERT INTO `user` VALUES (4406, '', '123', '', 1, '1', '发送');
INSERT INTO `user` VALUES (4407, '&#20313;', '123', '&#20313;', 1, '123', '&#25968;&#23383;');
INSERT INTO `user` VALUES (4408, '&#25968;&#23383;', '123', '&#25968;&#23383;', 1, '&#25968;&#23383;', '&#25968;&#23383;');
INSERT INTO `user` VALUES (4409, 'åéå°å', '123', 'åé¡ºä¸°', 1, '13288557012', 'æ³æ³');
INSERT INTO `user` VALUES (4410, '发顺丰', '123', '发电房', 1, '541153161', '发送');
